...
def normalizeData(data_train,data_test):
    ...
    """
    tmp_train = data_train.reshape(data_train.shape[0],96*96,3).astype('float32') / 255.
    tmp_test = data_test.reshape(data_test.shape[0],96*96,3).astype('float32')    / 255.
    ...
    return tmp_train.reshape(data_train.shape[0],96*96*3),tmp_test.reshape(data_test.shape[0],96*96*3)
