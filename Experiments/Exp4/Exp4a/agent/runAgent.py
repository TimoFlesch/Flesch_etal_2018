...
def runAgent(x_train,x_test):
    ...
    ckpt_dir_run = FLAGS.ckpt_dir + 'model_' + FLAGS.model + '_normalisedIMG_beta_' + str(FLAGS.beta)
    log_dir_run  = FLAGS.log_dir+'model_'+FLAGS.model + '_normalisedIMG_beta_' + str(FLAGS.beta)
