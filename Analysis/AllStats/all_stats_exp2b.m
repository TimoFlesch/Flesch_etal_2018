...
disp(['bias_b200; n: ' num2str(length(bias_b200))  ', mean: '  num2str(round(mean(bias_b200)*1000)/1000)  ', median: '  num2str(round(median(bias_b200)*1000)/1000) ', stdev: '	num2str(round(std(bias_b200,0,1)*1000)/1000) ', sem: ' num2str(round(std(bias_b200,0,1)./sqrt(length(bias_b200))*1000)/1000)])
disp(['bias_int; n: ' num2str(length(bias_int))  ', mean: '  num2str(round(mean(bias_int)*1000)/1000)  ', median: '  num2str(round(median(bias_int)*1000)/1000) ', stdev: '	num2str(round(std(bias_int,0,1)*1000)/1000) ', sem: ' num2str(round(std(bias_int,0,1)./sqrt(length(bias_int))*1000)/1000)])
...
disp('pooled hi vs lo:')
pooled_high = [b200_high,int_high];
pooled_low = [b200_low,int_low];
disp(['pooled_high; n: ' num2str(length(pooled_high))  ', mean: '  num2str(round(mean(pooled_high)*1000)/1000)  ', median: '  num2str(round(median(pooled_high)*1000)/1000) ', stdev: '	num2str(round(std(pooled_high,0,2)*1000)/1000) ', sem: ' num2str(round(std(pooled_high,0,2)./sqrt(length(pooled_high))*1000)/1000)])
disp(['pooled_low; n: ' num2str(length(pooled_low))  ', mean: '  num2str(round(mean(pooled_low)*1000)/1000)  ', median: '  num2str(round(median(pooled_low)*1000)/1000) ', stdev: '	num2str(round(std(pooled_low,0,2)*1000)/1000) ', sem: ' num2str(round(std(pooled_low,0,2)./sqrt(length(pooled_low))*1000)/1000)])

[p,~,stats] = ranksum(pooled_high,pooled_low);
r = compute_nonparametricEffectsize(stats.zval,length(pooled_high)+length(pooled_low));
fprintf([ 'pooled_high > pooled_low :\t p= ' num2str(round(p*1000)/1000) ',\t z: ' num2str(stats.zval) '\t r=' num2str(r) '\n']);


% accuracy - ANCOVA
disp('Accuracy - ANCOVA')
[~,atab,ctab,stats]= gridprior_ancova('acc',{'exp2b'});
...
pooled_high = [b200_high;int_high];
pooled_low = [b200_low;int_low];
disp(['pooled_high; n: ' num2str(length(pooled_high))  ', mean: '  num2str(round(mean(pooled_high)*1000)/1000)  ', median: '  num2str(round(median(pooled_high)*1000)/1000) ', stdev: '	num2str(round(std(pooled_high,0,1)*1000)/1000) ', sem: ' num2str(round(std(pooled_high,0,1)./sqrt(length(pooled_high))*1000)/1000)])
disp(['pooled_low; n: ' num2str(length(pooled_low))  ', mean: '  num2str(round(mean(pooled_low)*1000)/1000)  ', median: '  num2str(round(median(pooled_low)*1000)/1000) ', stdev: '	num2str(round(std(pooled_low,0,1)*1000)/1000) ', sem: ' num2str(round(std(pooled_low,0,1)./sqrt(length(pooled_low))*1000)/1000)])
[p,~,stats] = ranksum(pooled_high,pooled_low);
r = compute_nonparametricEffectsize(stats.zval,length(pooled_high)+length(pooled_low));
fprintf([ 'pooled_high > pooled_low :\t p= ' num2str(round(p*1000)/1000) ',\t z: ' num2str(stats.zval) '\t r=' num2str(r) '\n']);
...
% RSA - ANCOVA
disp('RSA - ANCOVA')
[~,atab,ctab,stats]= gridprior_ancova('rsa',{'exp2b'});
