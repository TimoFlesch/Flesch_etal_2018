function Y_HAT = freeBoundaryModel_singletrials(X_north,X_south,theta,numBounds)	
	% 
	...
	switch numBounds
		case 'twoBoundsAndSigmoids'
			X1    = scalarproj(X_north,theta(1));
			Y1    = transducer(X1,theta(3),theta(4),theta(5));
			X2    = scalarproj(X_south,theta(2));
